...
class CATEGORY_01_01_01 : Fragment() {
    ...
    private fun listData(): MutableList<ListItem> {
        ...
        return list.apply {
            ...
            add(ListItem(R.drawable.wellbeing, "웰빙뚝배기", "서울특별시 마포구 동교로12길 21 (서교동)", "한식", "2.2km", "3.3"))
            add(ListItem(R.drawable.western, "웨스턴후라이드라이스", "서울특별시 마포구 홍익로 26 (동교동)", "일식", "0.5km", "4.5"))
            add(ListItem(R.drawable.halbum, "할범탕수육", "서울특별시 양천구 목동중앙북로 15 (목동)", "분식", "4.4km", "5.0"))
        }
    }